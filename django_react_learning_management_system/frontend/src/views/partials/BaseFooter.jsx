        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 text-white">
            ...
            <div className="mb-4">
              ...
              <div className="mt-4">
                <p>
                  AmirHBana is feature-rich components and beautifully Bootstrap UIKit
                ...
                <div className="fs-4 mt-4">
                  ...
                  {/*Twitter*/}
                  <a href="https://www.linkedin.com/in/amirhossien-banayikhalilabad/" className="me-2 text-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg "
                      width={16}
                      height={16}
                  ...
                  {/*GitHub*/}
                  <a href="https://github.com/AmirHBana" className='text-white'>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={16}
                      height={16}
          ...
          <div className="col-lg-3 col-md-12">
            ...
            <div className="mb-4">
              ...
              <p className="mb-1">
                Email:
                <a href="#" className='text-white'> amir666arrow@gmail.com</a>
              </p>
              <p>
                Phone:
                <span className="text-dark fw-semibold">(+98) 9134460636</span>
              </p>
